...
<div>
  ...
  <div align=center>
      <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com/?font=VT323&size=35&duration=3500&pause=300&color=6A0572&center=true&vCenter=true&width=500&lines=Hey%2C+Eu+sou+o+Gulitti!;bem+vindo+a+Meu+perfil+do+GitHub+;Sou+um+programador;mecho+com+Software+;FrontEnd+e+BackEnd;amante+de+musica+e+programação;" alt="Typing SVG" /></a>
  </div>
</div>
 ...
 *
 * @constructor
 * @param {string} localização - Brasil, Sáo Paulo (SP)
 * @param {string} linguagens - Portugues e ingles
 * @param {string} esstudante - Software, TI e programação atualmente no SENAI
 * @param {string} interesses - desenvolvimento de programa, tanto mobile quanto de pc
```
...
<details>
  ...
  <blockquote>
    ...
    <br><strong>Tom Cargill</strong>
  </blockquote>
</details>
<details>
<summary>Como eu posso ajudar você?</summary>
...
responderei suas questões referentes a programação. Ofereço suporte na criação de sites ou outros programas.

  </td>
  <td width="50%" valign="top">

## Nunca Desista da programação!

**<img alt="Feedback" src="https://img.shields.io/badge/Ask%20me-anything-1abc9c.svg">**

<blockquote>“A sua imaginação é o limite de sua criação!”
<br><strong>– Gulitti Alvez</strong></blockquote>
